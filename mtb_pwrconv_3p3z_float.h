/***************************************************************************//**
* \file mtb_pwrconv_3p3z_float.h
* \version 1.0
* \brief Provides API declarations for the Power Conversion 3P3Z floating point regulator.
********************************************************************************
* \copyright
...
/**
 * \defgroup group_pwrconv_3p3z_float 3-pole 3-zero floating point regulator
 */

#ifndef MTB_PWRCONV_3P3Z_FLOAT_H
#define MTB_PWRCONV_3P3Z_FLOAT_H
...
/**
 * \addtogroup group_pwrconv_3p3z_float
 * \{
 */
...
typedef struct
{
    float32_t i[4]; /* Input values */
    float32_t o[4]; /* Output values */
} mtb_stc_pwrconv_reg_3p3z_float_dat_t;

/** The regulator working context data structure */
typedef struct
{
    mtb_stc_pwrconv_reg_3p3z_float_cfg_t cfg; /* The configuration parameters */
    mtb_stc_pwrconv_reg_3p3z_float_dat_t dat; /* The filter internal data */
                                                              ...
                                                              int32_t input, uint32_t * output)
{
    ...
    a  = ctx->cfg.b[3] * ctx->dat.i[2]; ctx->dat.i[2] = ctx->dat.i[1];
    ...
    a += ctx->cfg.a[3] * ctx->dat.o[2]; ctx->dat.o[2] = ctx->dat.o[1];
...
/** \} group_pwrconv_3p3z_float */

#ifdef __cplusplus
}
#endif

#endif /* MTB_PWRCONV_3P3Z_FLOAT_H */
